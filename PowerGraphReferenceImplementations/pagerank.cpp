 ...
 */
void init_vertex(graph_type::vertex_type& vertex) { vertex.data() = RESET_PROB; }
...
class pagerank :
  ...
  float last_change;
public:
  //MODIFIED TO CORRECTLY GATHER OVER THE IN_EDGES! eke
  ...
  void apply(icontext_type& context, vertex_type& vertex,
    ...
    //MODIFIED TO HANDLE CONVERGENCE CORRECTLY - eke
